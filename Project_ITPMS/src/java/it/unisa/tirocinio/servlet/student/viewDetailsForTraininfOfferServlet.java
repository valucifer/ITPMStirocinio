 ...
 * @author Valentino
 */
public class viewDetailsForTraininfOfferServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String vatNumberOrganization = "1";//request.getParameter("vatNumber");
            
            ConcreteOrganization anOrganization = ConcreteOrganization.getInstance();
            Organization organization = anOrganization.readOrganization(vatNumberOrganization);
            ...
            if(organization == null){
                ...
                out.println("message "+(organization.getEmail()));
            }
        } finally {
            out.close();
        }
