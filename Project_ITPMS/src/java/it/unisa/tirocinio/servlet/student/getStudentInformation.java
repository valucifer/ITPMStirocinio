...
public class getStudentInformation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String SSN = "vvv";//request.getParameter("SSN");
            ConcreteStudentInformation aStudentInformation = ConcreteStudentInformation.getInstance();
            StudentInformation studentInformation = aStudentInformation.readStudentInformation(SSN);
            ...
            out.println(studentInformation.getMatricula());
        } finally {
            out.close();
        }
    }
