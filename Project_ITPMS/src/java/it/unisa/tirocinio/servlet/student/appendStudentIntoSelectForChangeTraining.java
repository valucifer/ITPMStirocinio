 ...
 * @author Valentino
 */
@WebServlet(name = "appendStudentIntoSelectForChangeTraining", urlPatterns = {"/appendStudentIntoSelectForChangeTraining"})

public class appendStudentIntoSelectForChangeTraining extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(appendStudentIntoSelectForChangeTraining.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
