 ...
 * @author Valentino
 */
public class getProfessorStudentsViews extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ViewsResult aViewResultActive = aView.getProfessorStudentActiveTraining(professor.getSsn());
            ViewsResult aViewResultEnded = aView.getProfessorStudentEndedTraining(professor.getSsn());
