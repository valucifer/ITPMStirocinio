 ...
 * @author Valentino
 */
@WebServlet(name = "professorGetAllTrainingOffers", urlPatterns = {"/professorGetAllTrainingOffers"})

public class professorGetAllTrainingOffers extends HttpServlet {
        ...
        try {
            ...
            if(trainingOffer == null){
                ...
                for( TrainingOffer offer: trainingOffer ){
                    ...
                    jsonTmp.put("id", offer.getIdTrainingOffer());
                    array.put(jsonTmp);
                }
            ...
            Logger.getLogger(professorGetAllTrainingOffers.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
