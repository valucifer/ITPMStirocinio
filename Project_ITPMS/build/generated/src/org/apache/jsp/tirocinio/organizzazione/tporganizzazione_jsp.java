...
public final class tporganizzazione_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<a href=\"../../tirocinio/organizzazione/gestioneTirocinio&PlacementOrganizzazione.html\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<textarea id=\"descriptionTrainingForModify\" class=\"form-control\" placeholder=\"\" rows=\"5\" cols=\"5\" maxlength=\"250\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<button type=\"button\" id=\"modifyDataForTrainingIntoDatabase\" class=\"btn btn-orange\">Modifica</button>\n");
      out.write("\t\t\t\t\t</center>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
