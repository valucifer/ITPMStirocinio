...
public final class tpassociazioneprofessoreazienda_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" for=\"examsCarriedOut\">Organizzazioni: </label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<select name=\"organizationVAT\" id=\"comboboxOrganization\" class=\"form-control\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<br><br><br>\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"col-sm-2 control-label\" for=\"examsCarriedOut\">Professori</label>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\n");
